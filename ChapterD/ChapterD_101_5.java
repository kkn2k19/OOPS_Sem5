...
public class ChapterD_101_5 {
    public static void main(String[] args) {
        ...
        double squarePerimeter = obj.perimeter(5);
        System.out.println("Perimeter of Square with side 5 : " + squarePerimeter);
...
Perimeter of Rectangle with length 10.0 and breadth 5.0 : 30.0
Perimeter of Circle with radius 4.0 : 25.142857142857142
*/
